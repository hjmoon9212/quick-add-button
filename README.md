...
| **GCal 캘린더** | [tasks-gcal-sync](https://github.com/hjmoon9212/tasks-gcal-sync) 의 라우팅 태그 (`#gcal/Routine`). 붙이면 그 캘린더로 일정이 간다. 비워 두면 폼에 칸이 안 뜨고 줄에도 안 붙는다. 콤마로 여러 개 두면 폼에서 고르고, 폼에는 `없음` 도 있다 |
